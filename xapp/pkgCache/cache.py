...
from xapp.pkgCache import _apt
from xapp.pkgCache import _flatpak
from xapp.pkgCache.pkgInfo import PkgInfo

SYS_CACHE_PATH = "/var/cache/linuxmint/pkginfo.cache"
USER_CACHE_PATH = os.path.join(GLib.get_user_cache_dir(), "linuxmint", "pkginfo.cache")
